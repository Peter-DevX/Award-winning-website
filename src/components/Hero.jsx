...
const Hero = () => {
 ...
 useGSAP(() => {
    gsap.set('#video-frame', {
        clipPath: "polygon(15% 0%, 75% 0%, 90% 90%, 0% 100%)",
        borderRadius: '0 0 40% 3.5%'
    })
    ...
    <div className='relative h-dvh w-screen overflow-x-hidden'>
       ...
       {/*Video div (Video Frame)  */}
        <div id='video-frame' className='relative z-10 h-dvh w-screen overflow-hidden bg-blue-75'>
            ...
            <h1 className='special-font hero-heading z-40 absolute bottom-5 right-5 text-blue-50'>G<b>a</b>ming</h1>
            <div className='absolute left-0 top-0 z-40 size full'>
                <div className='mt-24 px-5 sm:px10'>
                    <h1 className='special-font hero-heading text-blue-50'>Redifi<b>n</b>e</h1>
                    <p className='mb-5 max-w-64 font-robert-regular text-blue-100'>Enter the META GAME layer <br/>
